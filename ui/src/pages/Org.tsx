...
export function Org() {
  ...
  if (!selectedCompanyId) {
    return (
      <EmptyState
        icon={GitBranch}
        message={t("orgChart.empty.selectCompany", {
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message={t("orgChart.empty.noAgents", {
            defaultValue: "No agents in the organization. Create agents to build your org chart.",
          })}
        />
      )}
