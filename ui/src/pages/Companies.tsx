...
export function Companies() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">{t("companies.states.loading", { defaultValue: "Loading companies..." })}</p>}
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {agentCount} {agentCount === 1
                      ? t("companies.stats.agentSingular", { defaultValue: "agent" })
                      : t("companies.stats.agentPlural", { defaultValue: "agents" })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {issueCount} {issueCount === 1
                      ? t("companies.stats.issueSingular", { defaultValue: "issue" })
                      : t("companies.stats.issuePlural", { defaultValue: "issues" })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("companies.stats.createdAt", { defaultValue: "Created {{time}}", time: relativeTime(company.createdAt) })}</span>
                </div>
              </div>
                  ...
                  <div className="flex items-center gap-2 ml-4 shrink-0">
                    ...
                    >
                      {deleteMutation.isPending
                        ? t("companies.actions.deleting", { defaultValue: "Deleting..." })
                        : t("companies.actions.delete", { defaultValue: "Delete" })}
                    </Button>
                  </div>
                </div>
              )}
