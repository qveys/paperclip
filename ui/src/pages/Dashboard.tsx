        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {tx("activeBudgetIncidents", {
                      count: data.budgets.activeIncidents,
                    })}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {tx("budgetIncidentDetails", {
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              to="/agents"
              description={tx("agentMetricDescription", {
            ...
            <MetricCard
              ...
              to="/issues"
              description={tx("taskMetricDescription", {
            ...
            <MetricCard
              ...
              description={
                data.budgets.pendingApprovals > 0
                  ? tx("pendingApprovalDescription", {
                      count: data.budgets.pendingApprovals,
                    })
                  : tx("awaitingBoardReview")
              }
            />
          </div>
            ...
            <div className="min-w-0">
              ...
              {recentIssues.length === 0 ? (
                <div className="border border-border p-4">
                  <p className="text-sm text-muted-foreground">{tx("noTasksYet")}</p>
                </div>
              ) : (
                <div className="border border-border divide-y divide-border overflow-hidden">
