        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {tx("dashboard.activeBudgetIncidents", {
                      count: data.budgets.activeIncidents,
                      suffix: data.budgets.activeIncidents === 1 ? "" : "s",
                    })}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {tx("dashboard.budgetIncidentDetails", {
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              to="/agents"
              description={tx("dashboard.agentMetricDescription", {
            ...
            <MetricCard
              ...
              to="/issues"
              description={tx("dashboard.taskMetricDescription", {
            ...
            <MetricCard
              ...
              description={
                data.budgets.pendingApprovals > 0
                  ? tx("dashboard.pendingApprovalDescription", {
                      count: data.budgets.pendingApprovals,
                    })
                  : tx("dashboard.awaitingBoardReview")
              }
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="min-w-0">
              <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-3">
                {tx("dashboard.recentTasks")}
              </h3>
              {recentIssues.length === 0 ? (
                <div className="border border-border p-4">
                  <p className="text-sm text-muted-foreground">{tx("dashboard.noTasksYet")}</p>
                </div>
              ) : (
                <div className="border border-border divide-y divide-border overflow-hidden">
