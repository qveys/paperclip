  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <CollapsibleTrigger className="flex w-full items-center justify-between rounded-lg border border-border/70 px-3 py-2 text-left">
        <div>
          <p className="text-sm font-medium">{t("routineVariablesEditor.variables", { defaultValue: "Variables" })}</p>
          <p className="text-xs text-muted-foreground">
            {t("routineVariablesEditor.detectedFromPlaceholders", {
              defaultValue: "Detected from `{{name}}` placeholders in the routine title and instructions.",
            })}
          </p>
        </div>
          ...
          <div key={variable.name} className="rounded-lg border border-border/70 p-4">
            <div className="mb-3 flex flex-wrap items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">
                {t("routineVariablesEditor.promptUserBeforeRun", {
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <div className="space-y-1.5">
                <Label className="text-xs">{t("routineVariablesEditor.label", { defaultValue: "Label" })}</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label className="text-xs">{t("routineVariablesEditor.type", { defaultValue: "Type" })}</Label>
                <Select
                  value={variable.type}
              ...
              <div className="space-y-1.5 md:col-span-2">
                <div className="flex items-center justify-between gap-3">
                  <Label className="text-xs">{t("routineVariablesEditor.defaultValue", { defaultValue: "Default value" })}</Label>
                  <label className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    />
                    {t("routineVariablesEditor.required", { defaultValue: "Required" })}
                  </label>
                </div>
                ...
                {variable.type === "textarea" ? (
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="__unset__">{t("routineVariablesEditor.noDefault", { defaultValue: "No default" })}</SelectItem>
                      <SelectItem value="true">{t("routineVariablesEditor.true", { defaultValue: "True" })}</SelectItem>
                      <SelectItem value="false">{t("routineVariablesEditor.false", { defaultValue: "False" })}</SelectItem>
                    </SelectContent>
                  </Select>
                ) : variable.type === "select" ? (
                  <div className="grid gap-3 md:grid-cols-2">
                    <div className="space-y-1.5">
                      <Label className="text-xs">{t("routineVariablesEditor.options", { defaultValue: "Options" })}</Label>
                      <Input
                        ...
                        placeholder={t("routineVariablesEditor.optionsPlaceholder", { defaultValue: "high, medium, low" })}
                      />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-xs">{t("routineVariablesEditor.defaultOption", { defaultValue: "Default option" })}</Label>
                      <Select
                      ...
                      >
                        <SelectTrigger>
                          <SelectValue placeholder={t("routineVariablesEditor.noDefault", { defaultValue: "No default" })} />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="__unset__">{t("routineVariablesEditor.noDefault", { defaultValue: "No default" })}</SelectItem>
                  ...
                  <Input
                    ...
                    placeholder={variable.type === "number"
                      ? t("routineVariablesEditor.numberPlaceholder", { defaultValue: "42" })
                      : t("routineVariablesEditor.defaultValue", { defaultValue: "Default value" })}
                  />
                )}
              </div>
            </div>
...
export function RoutineVariablesHint() {
  ...
  return (
    <div className="rounded-lg border border-dashed border-border/70 px-3 py-2 text-xs text-muted-foreground">
      {t("routineVariablesEditor.hint", {
        defaultValue: "Use `{{variable_name}}` placeholders in the instructions to prompt for inputs when the routine runs.",
      })}
    </div>
  );
}
