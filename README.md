...
Currently shipping: English (source), Français, Deutsch, and Español. Additional languages (日本語, 中文) are translated on Weblate and bundled in subsequent releases — see the rollout in [`docs/i18n-rollout.md`](docs/i18n-rollout.md).
