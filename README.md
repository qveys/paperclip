...
Currently shipping: English (source), Français, Deutsch, Español, and 日本語. Additional languages (中文) are translated on Weblate and bundled in subsequent releases — see the rollout in [`docs/i18n-rollout.md`](docs/i18n-rollout.md).
