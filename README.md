...
Currently shipping: English (source), Français, Deutsch, Español, 日本語, and 中文. Translations are managed on Weblate — see the rollout in [`docs/i18n-rollout.md`](docs/i18n-rollout.md).
